 ...
 */
export default class YJTiledMapData {

    /**地图大小 */
    public mapSize: cc.Size;
    /**单元格大小 */
    public tileSize: cc.Size;
    /**地图锚点 */
    public anchor: cc.Vec2;
    /**图层数据 */
    ...
    constructor(mapJson: any) {
        this.tileSize = new cc.Size(mapJson.tilewidth, mapJson.tileheight);
        let size = new cc.Size(mapJson.width, mapJson.height);
        this.mapSize = new cc.Size(size.width * this.tileSize.width, size.height * this.tileSize.height);
